...
{
    /// <summary>
    /// The screen that shows when the player loses the game.
    /// </summary>
    public class LoseScreen : Screen
    {
        private Label wordReveal;

        public LoseScreen(MainWindow window) : base(window) { }
        ...
        protected override void LoadElements()
        {
            ...
            Line mouth0 = LazyLine.CreateLine(370, 220, 350, 240, 3);
            AddChild(mouth0);

            Line mouth1 = LazyLine.CreateLine(370, 220, 430, 220, 3);
            AddChild(mouth1);

            Line mouth2 = LazyLine.CreateLine(430, 220, 450, 240, 3);
            AddChild(mouth2);
